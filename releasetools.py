...
def FullOTA_InstallEnd(info):
  ...
  info.script.AppendExtra('ifelse(is_substring("N900S", getprop("ro.bootloader")), run_program("/sbin/sh", "-c", "busybox cp /system/lib/gsm/* /system/lib/"));')
  info.script.AppendExtra('ifelse(is_substring("N900K", getprop("ro.bootloader")), run_program("/sbin/sh", "-c", "busybox cp /system/lib/gsm/* /system/lib/"));')
